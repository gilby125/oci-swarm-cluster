...
variable "cloudflare_email" {
  type        = string
  description = "Cloudflare Email for DNS challenges"
  default     = ""
}
...
variable "pangolin_token" {
  type        = string
  description = "JWT secret for the Pangolin service"
  default     = ""
  sensitive   = true
}
...
variable "pangolin_admin_password" {
  type        = string
  description = "Admin password for the Pangolin service"
  default     = ""
  sensitive   = true
}

# Additional variables needed for the codebase
